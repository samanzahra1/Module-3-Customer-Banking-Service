...
def main():
    ...
    savings_account_balance = float(input("what is your current savings account balance? "))
    savings_account_interest_rate = float(input("what is the interest rate on your account? "))
    savings_account_months =int(input("whats the time in months? "))
    ...
    # ADD YOUR CODE HERE
    cd_account_balance = float(input("what is your current savings cd balance? "))
    cd_account_interest = float(input("what is the interest rate on your cd? "))
    cd_account_months =int(input("whats the time in months? "))
